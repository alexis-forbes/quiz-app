...
describe('Play component', () => {
  ...
  // test('Verify if no answer', async () => {
  //   // Render the App
  //   const {getByText} = render(<Play />);
  //   act(() => {
  ...
  //   });
  //   //setTimeout(async () => {
  //     const questions = await waitFor(() => getByText(/1 of 10/i));
  //     expect(questions).toBeInTheDocument();      
  //   //}, 16000);
  // });

  // test('Verify if no answer 2', async () => {
  //   // Render the App
  //   const {getByText} = render(<Play />);
  //   act(() => {
  ...
  //   });
  //   // setTimeout(async () => {
  //     const questions = await waitFor(() => getByText(/3 of 10/i));
  //     expect(questions).toBeInTheDocument();      
  //   // }, 32000);
  // });
});